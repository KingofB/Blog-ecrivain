...
<main role="main">
    <div class="jumbotron mt-5 text-white">
        <div class="container">
            ...
            <p><a class="btn btn-primary btn-lg" href="/proj4/index.php?action=article&amp;article_id=<?= $last_article['id'] ?>" role="button">Découvrir le dernier extrait</a></p>
        </div>
    </div>
            ...
            <?php foreach ($last_3_articles as $article) { ?>
                <div class="card col-md-4  pt-3" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        ...
                        <a href="/proj4/index.php?action=article&amp;article_id=<?= $article['id'] ?>" class="btn btn-primary">Lire l'extrait</a>
                    </div>
                </div>
            <?php } ?>
        </div>
        ...
        <div class="row">
            ...
            <div class="card col-md-3  pt-3" style="width: 18rem;" id="archives">
                ...
                <?php foreach ($archives as $article) { ?>
                    <ul>
                        <li><a href="/proj4/index.php?action=article&amp;article_id=<?= $article['id'] ?>"><?= htmlspecialchars($article['title']) ?></a></li>
                    </ul>
                <?php } ?>
            </div>
        </div>
